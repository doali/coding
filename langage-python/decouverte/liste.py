...
val_2 = 7
l = range(6)
print 'La liste %s contient la valeur %s ? : %s et la valeur %s ? : %s' % (l, val_1, l.__contains__(val_1), val_2, l.__contains__(val_2))
...
l = [1,2,2,3,4,2,3]
val = 2
print 'Soit la liste %s contenant %s occurrences de la valeur %s' % (l, l.count(val), val)
